...
mcp = FastMCP("owaiken", log_level="ERROR")
...
async def create_thread() -> str:
    """Create a new conversation thread for Owaiken.
    Always call this tool before invoking Owaiken for the first time in a conversation.
...
async def run_agent(thread_id: str, user_input: str) -> str:
    """Run the Owaiken agent with user input.
    ...
    After you receive the code from Owaiken, always implement it into the codebase unless asked not to.
