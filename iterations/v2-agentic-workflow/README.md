...
Note that we are still relying on OpenAI for embeddings no matter what, but future versions of Owaiken will change that.
...
cd owaiken/iterations/v2-agentic-workflow
```
