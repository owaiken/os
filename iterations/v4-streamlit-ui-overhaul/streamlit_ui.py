...
# Set custom theme colors to match Owaiken logo (green and pink)
...
def generate_mcp_config(ide_type):
    ...
    if ide_type == "Windsurf":
        ...
        return f"{python_path} {server_script_path}", f"docker run --rm -p 8100:8100 owaiken:latest python mcp_server.py"
    elif ide_type == "Cline":
...
def mcp_tab():
    ...
    if st.session_state.selected_ide:
        ...
        with config_tab2:
            ...
            st.markdown("- Must be running Owaiken not within a container")           
...
async def chat_tab():
    """Display the chat interface for talking to Owaiken"""
...
def intro_tab():
    """Display the introduction and setup guide for Owaiken"""
    # Display the banner image
    st.image("public/Owaiken.png", use_container_width=True)
    
    # Welcome message
    st.markdown("""
    # Welcome to Owaiken!
    
    Owaiken is an AI meta-agent designed to autonomously build, refine, and optimize other AI agents.
    
    It serves both as a practical tool for developers and as an educational framework demonstrating the evolution of agentic systems.
    Owaiken is developed in iterations, starting with a simple Pydantic AI agent that can build other Pydantic AI agents,
    ...
    st.markdown("Follow these concise steps to get Owaiken up and running (IMPORTANT: come back here after each step):")
    ...
    with st.expander("Step 1: Environment Configuration", expanded=True):
        ...
        These settings determine how Owaiken connects to external services and which models it uses.
        """)
    ...
    with st.expander("Step 2: Database Setup", expanded=False):
        ...
        Owaiken uses Supabase for vector storage and retrieval:
    ...
    with st.expander("Step 5: MCP Configuration (Optional)", expanded=False):
        ...
        This enables you to use Owaiken directly from your AI-powered IDE.
        """)
    ...
    # Step 6: Using Owaiken
    with st.expander("Step 6: Using Owaiken", expanded=False):
        st.markdown("""
        ### Using Owaiken
        ...
        3. Owaiken will plan and generate the necessary code
        
        You can also use Owaiken directly from your AI IDE if you've configured MCP.
        """)
    ...
    - [GitHub Repository](https://github.com/coleam00/owaiken)
    - [Owaiken Community Forum](https://thinktank.ottomator.ai/c/owaiken/30)
            ...
            with col1:
                ...
                if st.button("Crawl Pydantic AI Docs", key="crawl_pydantic") and not (st.session_state.crawl_tracker and st.session_state.crawl_tracker.is_running):
                    try:
                        ...
                        from owaiken.crawl_pydantic_ai_docs import start_crawl_with_requests
                ...
                if st.button("Clear Pydantic AI Docs", key="clear_pydantic"):
                    with st.spinner("Clearing existing Pydantic AI docs..."):
                        try:
                            ...
                            from owaiken.crawl_pydantic_ai_docs import clear_existing_records
...
def database_tab():
    ...
    st.write("Set up and manage your Supabase database tables for Owaiken.")
...
def agent_service_tab():
    ...
    st.write("Start, restart, and monitor the Owaiken agent service for MCP.")
    ...
    with st.container():
        ...
        st.text_area(
            label="Realtime Logs from Owaiken Service",
            value=output_text,
...
def environment_tab():
    ...
    st.write("- Configure your environment variables for Owaiken. These settings will be saved and used for future sessions.")
...
async def main():
    ...
    with st.sidebar:
        st.image("public/OwaikenLightGrey.png", width=1000)
