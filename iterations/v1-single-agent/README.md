# Owaiken V1 - Basic Pydantic AI Agent to Build other Pydantic AI Agents

This is the first iteration of the Owaiken project - no use of LangGraph and built with a single AI agent to keep things very simple and introductory.
...
cd owaiken/iterations/v1-single-agent
```
